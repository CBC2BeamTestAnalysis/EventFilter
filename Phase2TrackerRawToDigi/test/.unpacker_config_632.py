...
process.MessageLogger = cms.Service("MessageLogger",
       destinations   = cms.untracked.vstring('/home/xtaldaq/unpacker_output/log/run632_detailed.log', '/home/xtaldaq/unpacker_output/log/run632_critical.log' ),
...
process.source = cms.Source("NewEventStreamFileReader",
    fileNames = cms.untracked.vstring( 'file://home/xtaldaq/storageManager/closed/USC.00000632.0001.A.storageManager.00.0000.dat')
)
...
process.out = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('/home/xtaldaq/unpacker_output/rawData/USC.00000632.0001.A.storageManager.00.0000.root')
)
